...
define('global_project_website', 'http://www.fortuneservices.biz/tennis');
...
mysql_connect('localhost','root','root')or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysql_error()) . '</span>');
mysql_select_db('tennis')or die('<span class="error_span"><u>MySQL error:</u> ' . htmlspecialchars(mysql_error()) . '</span>');
